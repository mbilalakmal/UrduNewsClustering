...
def get_similar_documents(query_doc_id: int, documents: dict, threshold: float = 0.5) -> List[int]:
    """
    ...
    for doc_id, document in documents.items():
        jackard_index: float = get_jackard_index(query_document, document)
...
def get_jackard_index(document1: Document, document2: Document) -> float:
